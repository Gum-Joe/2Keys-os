...
// Struct with implementation for Registering
// Make it easier to write (safe abstraction)
// Instead of using pointers etc
...
// Struct that will be exposed for use
pub struct MiniUart;
...
// Actual implementation of MiniUart for use
impl MiniUart {
	pub fn new() -> MiniUart {
		MiniUart // Creates a new one of this
	}
	...
	// The actual function to init the usrt
	pub fn init(&self) {
		// Begin by initing
		// initialize UART
